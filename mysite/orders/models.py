...
class Order(models.Model):
    ...
    email = models.EmailField(
        verbose_name=_("Email для чека"), default="test@example.com"
    )
    status = models.CharField(
        max_length=20, default="pending", verbose_name=_("Статус")
    )
...
class OrderItem(models.Model):
    ...
    price = models.DecimalField(
        max_digits=10, decimal_places=2, verbose_name=_("Ціна під час покупки")
    )
